...
export type PlanWhereInput = {
  ...
  monthly_quota?: Prisma.IntFilter<"Plan"> | number
  max_resumes?: Prisma.IntFilter<"Plan"> | number
  subscriptions?: Prisma.SubscriptionListRelationFilter
}

export type PlanOrderByWithRelationInput = {
  code?: Prisma.SortOrder
  monthly_quota?: Prisma.SortOrder
  max_resumes?: Prisma.SortOrder
...
export type PlanScalarWhereWithAggregatesInput = {
  ...
  monthly_quota?: Prisma.IntWithAggregatesFilter<"Plan"> | number
  max_resumes?: Prisma.IntWithAggregatesFilter<"Plan"> | number
}
...
export type PlanUpdateInput = {
  ...
  monthly_quota?: Prisma.IntFieldUpdateOperationsInput | number
  max_resumes?: Prisma.IntFieldUpdateOperationsInput | number
...
export type PlanOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"code" | "monthly_quota" | "max_resumes", ExtArgs["result"]["plan"]>
...
export interface PlanDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `monthly_quota`
   * const planWithMonthly_quotaOnly = await prisma.plan.findMany({ select: { monthly_quota: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Plans and only return the `monthly_quota`
   * const planWithMonthly_quotaOnly = await prisma.plan.createManyAndReturn({
   *   select: { monthly_quota: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more Plans and only return the `monthly_quota`
   * const planWithMonthly_quotaOnly = await prisma.plan.updateManyAndReturn({
   *   select: { monthly_quota: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PlanFieldRefs {
  ...
  readonly monthly_quota: Prisma.FieldRef<"Plan", 'Int'>
  readonly max_resumes: Prisma.FieldRef<"Plan", 'Int'>
}
